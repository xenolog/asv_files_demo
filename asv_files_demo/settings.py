...
SECRET_KEY = 'qn1fx#5u-gv+j@d5u0rycybpq1#%wmx==i*y^8jokat(mz9hva'
...
ROOT_URLCONF = 'asv_files_demo.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'asv_files_demo.wsgi.application'
...
TEMPLATE_CONTEXT_PROCESSORS = (
    ...
    #'asv_media.context_processors.lib_urls',
)
